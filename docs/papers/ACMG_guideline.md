...
Richards, David Bick, Soma Das, Wayne Grody, Elaine Spector, Julie Gastier-Foster, Nazneen Aziz, and Karl Voelkerding. The
...
not necessarily assure a successful medical outcome. These Standards and Guidelines should not be considered inclusive of all proper
...
guidance for the interpretation of sequence variants.1 In the past decade, sequencing technology
...
performed in a CLIA-approved laboratory with results interpreted by a board-certified clinical
...
detailed variant classification guidance.1 This report describes updated standards and
...
their laboratories and/or by the broader community. In addition, typical examples of variants
...
programs for quantitative evaluation of variants in select diseases.2–5 While those variant
...
to incorrect assumptions of pathogenic and benign effects respectively. Thus, it is
...
for classifying copy number variants (CNVs) detected by cytogenetic microarray.6 The
...
Cancer (IARC) guideline2 supports a 95% level of certainty of pathogenicity, but the
...
Society (HGVS)7 and its use is recommended as the primary guideline for determining
variant nomenclature except as noted.6 Laboratories should note the version being used in
...
(http://www.ncbi.nlm.nih.gov/RefSeq/)9 with the version number or the Locus Reference
Genomic (LRG) database (http://www.lrg-sequence.org).10 Genomic coordinates should be
...
transcripts can often be identified through LRG10, CCDS Database11, Human Gene
...
recommendations, but possible descriptions for complex variants have been reported.7,12 In
...
sequences. Databases can be useful for gathering information, but should be used with
caution.
...
Accountability Act (HIPAA) regulations for privacy. Clinical laboratories are encouraged to
...
laboratories include PolyPhen219, SIFT20 and MutationTaster21. A list of missense variant
...
programs each have their own strengths and weaknesses depending on the algorithm and in
...
that as “actionable” and to alter the treatment or surveillance of a patient25 or remove such
...
moderate (PM1–6), or supporting (PP1–5) and each benign criterion is weighted as stand-
...
penultimate exon such that nonsense-mediated decay26 would not be predicted and
...
It is important to consider the presence of alternate gene transcripts and understand
...
change that results in the same amino acid [e.g. c.34G>C (p.Val12Leu) and c.34G>T
(p.Val12Leu)] can also be assumed to be pathogenic, particularly if the mechanism of
...
C. The phenotype in the patient matches the gene’s disease association with
...
a missense variant on enzymatic function in a metabolic pathway (e.g. α-galactosidase
...
Variant Server, Exome Aggregation Consortium (ExAC); see Table 1) as well as using race-
...
documented healthy adult individual for a recessive (homozygous), dominant
...
(CI) around the OR is as important as the measure of association itself. If the CI includes 1.0
(e.g. OR= 2.5, CI = 0.9–7.4), there is little confidence in the assertion of association. In the
...
nearby residues have been observed with greater frequency. Either evidence can be
...
p.Lys650Gln or p.Lys650Asn causes mild hypochondroplasia, p.Lys650Met causes severe
...
variant itself. A statistical approach has been published29,30 with the caveat that the
...
known pathogenic variant into a single quantitative measure of pathogenicity.31 Distant
...
recessive disorder; therefore, this evidence is much stronger for supporting a likely benign
...
The results section should list variants using HGVS nomenclature (see Nomenclature
...
predictive algorithms (see In Silico Predictive Programs section above). A discussion of
...
for transcripts and genome build including versions. For large panels, gene level information
...
Please see ACMG guidelines on duty to re-contact regarding physician responsibility.39
...
that disease.5 For example, additional cases with matching rare phenotypes and deleterious
...
(see also nomenclature). The current accepted reference sequence is the Revised Cambridge
...
www.mtdb.igp.uu.se/),43 secondary structures, sequences, and alignment of mitochondrial
tRNAs (http://mamit-trna.u-strasbg.fr/),44 mitochondrial haplogroups (http://
www.phylotree.org/)45and other information (http://www.mtdnacommunity.org/
default.aspx),46 may prove useful in interpreting mitochondrial variants.
...
heteroplasmy and disease severity.47 Muscle, liver or urine may be additional specimen
...
used in clinical care. Gene summaries and clinically relevant variants can be found at the
Pharmacogenomics Knowledge Base (PharmGKB; http://www.pharmgkb.org/).48 Alleles
and nomenclature for the cytochrome P450 gene family is available at http://
www.cypalleles.ki.se/.49 Although the interpretation of pharmacogenomic (PGx) variants is
...
rather than family-based studies.50,51 Currently, numerous GWAS reports have resulted in
...
for example, or are in linkage disequilibrium with causal variants.52

Common, complex risk alleles typically confer low relative risk and are meager in their
predictive power.53 To date, the utility of common, complex risk allele testing for patient
care54 has been unclear and models to combine multiple markers into a cumulative risk
score are often flawed and are usually no better than traditional risk factors such as family
history, demographics and non-genetic clinical phenotypes.55,56 Moreover, in almost all of
...
However, we recognize that some of these alleles are identified during the course of
...
complete clinical information is so essential for the interpretation of genome-level DNA
...
exome and genome sequencing, particularly for suspected recessive or de novo causes.
...
laboratory to aid in variant interpretation. Ideally, it is recommended that clinical data be
...
decision-making. However, it is recommended that all possible follow-up testing, as
...
6. Kearney HM, Thorland EC, Brown KK, Quintero-Rivera F, South ST. American College of
...
7. Nomenclature for the description of sequence variants: Human Genome Variation Society. 2013

Available at https://www.hgvs.org/mutnomen.

8. Wildeman M, van Ophuizen E, den Dunnen JT, Taschner PE. Improving sequence variant
...
9. [Accessed November 4, 2014] RefSeq: NCBI Reference Sequence Database. 2014. Available at

https://www.ncbi.nlm.nih.gov/refseq

10. Locus Reference Genomic. 2011 Available at https://www.lrg-sequence.org.
11. [Accessed November 4, 2014] Concensus CDS Database NCBI. 2014. Available at https://

www.ncbi.nlm.nih.gov/CCDS/CcdsBrowse.cgi

12. Taschner PE, den Dunnen JT. Describing structural changes by extending HGVS sequence

variation nomenclature. Hum Mutat. 2011; 32:507–511. [PubMed: 21309030]

13. Kircher M, Witten DM, Jain P, O'Roak BJ, Cooper GM, Shendure J. A general framework for
estimating the relative pathogenicity of human genetic variants. Nat Genet. 2014; 46:310–315.
[PubMed: 24487276]

14. Hicks S, Wheeler DA, Plon SE, Kimmel M. Prediction of missense mutation functionality depends

on both the algorithm and sequence alignment employed. Hum Mutat. 2011; 32:661–668.
[PubMed: 21480434]

15. Tavtigian SV, Greenblatt MS, Lesueur F, Byrnes GB. In silico analysis of missense substitutions

using sequence-alignment based methods. Hum Mutat. 2008; 29:1327–1336. [PubMed: 18951440]
16. Thusberg J, Olatubosun A, Vihinen M. Performance of mutation pathogenicity prediction methods

on missense variants. Hum Mutat. 2011; 32:358–368. [PubMed: 21412949]

17. Thompson BA, Greenblatt MS, Vallee MP, et al. Calibration of multiple in silico tools for

predicting pathogenicity of mismatch repair gene missense substitutions. Hum Mutat. 2013;
34:255–265. [PubMed: 22949387]

18. Choi Y, Sims GE, Murphy S, Miller JR, Chan AP. Predicting the functional effect of amino acid

substitutions and indels. PLoS One. 2012; 7:e46688. [PubMed: 23056405]

19. Adzhubei IA, Schmidt S, Peshkin L, et al. A method and server for predicting damaging missense

mutations. Nat Methods. 2010; 7:248–249. [PubMed: 20354512]

20. Kumar P, Henikoff S, Ng PC. Predicting the effects of coding non-synonymous variants on protein

function using the SIFT algorithm. Nat Protoc. 2009; 4:1073–1081. [PubMed: 19561590]
21. Schwarz JM, Rodelsperger C, Schuelke M, Seelow D. MutationTaster evaluates disease-causing

potential of sequence alterations. Nat Methods. 2010; 7:575–576. [PubMed: 20676075]
22. Jian X, Boerwinkle E, Liu X. In silico tools for splicing defect prediction: a survey from the

viewpoint of end users. Genet Med. 2014; 16:497–503. [PubMed: 24263461]

23. Houdayer C, Caux-Montcoutier V, Krieger S, et al. Guidelines for splicing analysis in molecular
...
24. Vreeswijk MP, Kraan JN, van der Klift HM, et al. Intronic variants in BRCA1 and BRCA2 that

affect RNA splicing can be reliably selected by splice-site prediction programs. Hum Mutat. 2009;
30:107–114. [PubMed: 18693280]

25. Henderson LB, Applegate CD, Wohler E, Sheridan MB, Hoover-Fong J, Batista DA. The impact
of chromosomal microarray on clinical management: a retrospective analysis. Genet Med. 2014;
16:657–664. [PubMed: 24625444]

26. Popp MW, Maquat LE. Organizing principles of mammalian nonsense-mediated mRNA decay.

Annu Rev Genet. 2013; 47:139–165. [PubMed: 24274751]

27. Calculator for confidence intervals of odds ratio in an unmatched case control study. For example
...
28. Odds Ratio Confidence Interval Calculator. Available at http://www.easycalculation.com/statistics/

odds-ratio.

29. Bayrak-Toydemir P, McDonald J, Mao R, et al. Likelihood ratios to assess genetic evidence for
...
30. Thompson D, Easton DF, Goldgar DE. A full-likelihood method for the evaluation of causality of

sequence variants from family data. Am J Hum Genet. 2003; 73:652–655. [PubMed: 12900794]

31. Goldgar DE, Easton DF, Deffenbaugh AM, et al. Integrated evaluation of DNA sequence variants
of unknown clinical significance: application to BRCA1 and BRCA2. Am J Hum Genet. 2004;
75:535–544. [PubMed: 15290653]

32. Scheuner MT, Hilborne L, Brown J, Lubin IM. A report template for molecular genetic tests
...
33. Lubin IM, Caggana M, Constantin C, et al. Ordering molecular genetic tests and reporting results:
practices in laboratory and clinical settings. J Mol Diagn. 2008; 10:459–468. [PubMed: 18669879]
34. Lubin IM, McGovern MM, Gibson Z, et al. Clinician perspectives about molecular genetic testing
...
35. Rehm HL, Bale SJ, Bayrak-Toydemir P, et al. ACMG clinical laboratory standards for next-

generation sequencing. Genet Med. 2013; 15:733–747. [PubMed: 23887774]

36. Aziz N, Zhao Q, Bry L, et al. College of American Pathologists' Laboratory Standards for Next-

Generation Sequencing Clinical Tests. Arch Pathol Lab Med. 2014

37. Aronson SJ, Clark EH, Varugheese M, et al. Communicating new knowledge on previously

reported genetic variants. Genet Med. 2012

38. Bean LJ, Tinker SW, da Silva C, Hegde MR. Free the data: one laboratory's approach to
...
39. Hirschhorn K, Fleischer LD, Godmilow L, et al. Duty to re-contact. Genet Med. 1999; 1:171–172.

[PubMed: 11258354]

40. Revised Cambridge Reference Sequence (rCRS) of the Human Mitochondrial DNA: GenBank

sequence NC_012920 gi:251831106.

41. Behar DM, Oven MV, Rosset S, et al. A "Copernican" reassessment of the human mitochondrial

DNA tree from its root. Am J Hum Genet. 2012; 90:675–684. [PubMed: 22482806]

42. MITOMAP: A human mitochondrial genome database. 2014 Available at http://mitomap.org/bin/

view.pl/MITOMAP/WebHome.

43. mt-DB- Human Mitochondrial Genome Database. 2007 Available at http://www.mtdb.igp.uu.se.
44. Compilation of mammalian mitochondrial tRNA genes. 2007 Available at http://mamit-trna.u-

strasbg.fr/Summary.asp.

45. van Oven M, Kayser M. Updated comprehensive phylogenetic tree of global human mitochondrial

DNA variation. Hum Mutat. 2009; 30:E386–E394. http://www.phylotree.org. [PubMed:
18853457]

46. mtDNA Community. 2014 Available at http://www.mtdnacommunity.org/default.aspx/.
47. Wong LJ. Diagnostic challenges of mitochondrial DNA disorders. Mitochondrion. 2007; 7:45–52.

[PubMed: 17276740]

48. PharmGKB. 2014 Available at http://www.pharmgkb.org.
49. The Human Cytochrome P450 (CYP) Allele Nomenclature Database. Available at http://

www.cypalleles.ki.se/.

50. Manolio TA. Genomewide association studies and assessment of the risk of disease. N Engl J Med.

2010; 363:166–176. [PubMed: 20647212]

51. Hardy J, Singleton A. Genomewide association studies and human disease. N Engl J Med. 2009;

360:1759–1768. [PubMed: 19369657]

52. Kruglyak L. Prospects for whole-genome linkage disequilibrium mapping of common disease
...
Beware of changes that impact splicing rather than at the
